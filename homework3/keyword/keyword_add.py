...
def process_articles():
    ...
    # 加载数据
    print("加载数据...")
    articles = load_jsonl('keyword/primary_output.jsonl')
...
def save_statistics(statistics):
    ...
    save_jsonl(stats_list, 'keyword/statistics_report.jsonl')
...
def main():
    ...
    try:
        ...
        # 保存处理后的文章
        print("\n保存处理后的文章...")
        save_jsonl(processed_articles, 'keyword/keyword_output.jsonl')
        ...
        print("\n处理完成!")
        print(f"处理结果保存在: keyword/keyword_output.jsonl")
        print(f"统计报告保存在: keyword/statistics_report.jsonl")
